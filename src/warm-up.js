...
var vegetables = ['zuchini', 'eggplant', 'squash', 'peppers', 'onions'];
...
// different fruits.
var fruits = ['lemons', 'oranges', 'bananas', 'blueberries', 'raspberries', 'mangos', 'limes'];
...
groceryStore.hasPharmacy = false;
groceryStore.parkingSpaces = 78;
groceryStore.hours = '7am to 11pm';
